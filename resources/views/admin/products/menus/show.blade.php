            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header custom-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('menus.edit', $menu->id) }}" class="btn btn-warning ml-auto"><i class="fas fa-edit"></i></a>
                    </div>
                    <div class="card-body d-flex flex-column flex-md-row">
                        <div class="flex-grow-1">
                            ...
                            <div class="dishes-list">
                                @php
                                    $categoriesOrder = ['Entrée', 'Soupe', 'Plat', 'Accompagnement', 'Dessert', 'Boisson'];
                                    $sortedDishes = $dishes->sortBy(function($dish) use ($categoriesOrder) {
                            ...
                            <div class="ml-3 mt-3 mt-md-0 d-flex justify-content-center justify-content-md-start">
                                <img src="{{ $menu->photo }}" alt="{{ $menu->name }}" class="img-fluid rounded shadow1" style="max-width: 250px;">
                            </div>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer d-flex justify-content-between align-items-center">
                            <a href="{{ route('menus.index') }}" class="btn custom-button"><i class="fas fa-arrow-left"></i> Retour à la liste</a>
